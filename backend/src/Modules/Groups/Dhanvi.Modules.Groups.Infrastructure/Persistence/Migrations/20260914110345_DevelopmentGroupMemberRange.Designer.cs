...
namespace Dhanvi.Modules.Groups.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260914110345_DevelopmentGroupMemberRange")]
    partial class DevelopmentGroupMemberRange
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dhanvi.Modules.Auctions.Domain.Auction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("CurrentHighestDiscount")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<Guid?>("CurrentWinningMembershipId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset?>("WinnerSelectedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("CurrentWinningBidId", "Id", "CurrentWinningMembershipId");

                    b.ToTable("Auctions", "groups", t =>
                        {
            ...
            modelBuilder.Entity("Dhanvi.Modules.Auctions.Domain.AuctionBenefitAllocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AuctionResultId")
                        .IsUnique()
                        .HasFilter("\"AllocationType\" = 'PlatformFee'");

                    b.HasIndex("AuctionResultId", "GroupId");

                    b.HasIndex("AuctionResultId", "MembershipId")
                        .IsUnique()
                        .HasFilter("\"MembershipId\" IS NOT NULL");

                    b.HasIndex("MembershipId", "GroupId");

                    b.ToTable("AuctionBenefitAllocations", "groups", t =>
                        {
            ...
            modelBuilder.Entity("Dhanvi.Modules.Auctions.Domain.AuctionBid", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AuctionId", "MembershipId", "IdempotencyKey")
                        .IsUnique();

                    b.ToTable("AuctionBids", "groups", t =>
                        {
                            t.HasCheckConstraint("CK_AuctionBid_AmountSequence", "\"DiscountAmount\" > 0 AND \"SequenceNumber\" > 0");
                        });
                });

            modelBuilder.Entity("Dhanvi.Modules.Auctions.Domain.AuctionResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("GrossMemberShare")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<decimal>("MemberBenefitPool")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<decimal>("WinnerPayout")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<decimal>("WinningDiscount")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.HasIndex("WinningBidId", "AuctionId", "WinnerMembershipId");
            ...
            modelBuilder.Entity("Dhanvi.Modules.Auctions.Domain.Auction", b =>
                {
                    ...
                    b.HasOne("Dhanvi.Modules.Auctions.Domain.AuctionBid", null)
                        .WithMany()
                        .HasForeignKey("CurrentWinningBidId", "Id", "CurrentWinningMembershipId")
            ...
            modelBuilder.Entity("Dhanvi.Modules.Auctions.Domain.AuctionBenefitAllocation", b =>
                {
                    b.HasOne("Dhanvi.Modules.Auctions.Domain.AuctionResult", null)
                        .WithMany("Allocations")
                        .HasForeignKey("AuctionResultId", "GroupId")
                        .HasPrincipalKey("Id", "GroupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
