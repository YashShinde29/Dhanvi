...
import { LinkButton, Brand } from "@dhanvi/ui";

/** Marketing/auth shell of the member app. */
    ...
    <header className="public-header">
      <div className="public-header__inner">
        ...
        <div className="public-header__actions">
          {auth.authenticated ? (
            <LinkButton href={dashboardHref} size="sm">Go to dashboard</LinkButton>
          ) : (
            <>
...
export function PublicShell({ children, dashboardHref = "/dashboard" }: { children: ReactNode; dashboardHref?: string }) {
  return (
    <div className="shell">
